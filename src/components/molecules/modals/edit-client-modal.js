    ...
    <ModalWrapper
      ...
      <View style={styles.container}>
        ...
        <PrimaryInput
          ...
          onChangeText={str => onChange({...department, client_name: str})}
          value={department?.client_name}
        />
        <PrimaryInput
          keyboardType={'email-address'}
          // error={errors?.email}
          ...
          onChangeText={str => onChange({...department, c_mobile_no: str})}
          value={department?.c_mobile_no}
        />
        <PrimaryInput
          keyboardType={'email-address'}
          // error={errors?.email}
          ...
          onChangeText={str => onChange({...department, address_1: str})}
          value={department?.address_1}
        />
        <PrimaryInput
          keyboardType={'email-address'}
          // error={errors?.email}
          ...
          onChangeText={str => onChange({...department, address_2: str})}
          value={department?.address_2}
        />
        <PrimaryButton
          // disabled={
