      ...
      <View style={styles.container}>
        <View style={styles.departmenstlistcontainer}>
          <Row
            ...
            <Bold label={user?.username} fontSize={mvs(16)} />
          </Row>
          <View style={{paddingVertical: mvs(5)}}>
            ...
            {user?.profile_description && (
              <Row style={{paddingBottom: mvs(5)}}>
                ...
                />
                <Regular
                  label={user?.profile_description}
                  fontSize={mvs(13)}
                  color={colors.lightblack}
                  style={{flex: 1}}
                />
            ...
            {user?.created_at && (
              <Row style={{paddingBottom: mvs(5)}}>
                ...
                />
                <Regular
                  label={moment(user?.created_at).format(
            ...
            {user?.updated_at && (
              <Row style={{paddingBottom: mvs(5)}}>
                ...
                />
                <Regular
                  label={moment(user?.updated_at).format(
                    'ddd, MMM Do YYYY, h:mm A',
                  )}
                  fontSize={mvs(13)}
                  color={colors.lightblack}
